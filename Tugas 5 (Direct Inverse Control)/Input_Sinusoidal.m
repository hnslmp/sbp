...
input = [y_sinusoid(2:1505)' y_sinusoid(1:1504)' u_sinusoid(3:1506)' u_sinusoid(2:1505)' u_sinusoid(1:1504)']; 
target = y_sinusoid(3:1506)';
...
% Data Input
input_testing = [y_sinusoid(1506:3009)' y_sinusoid(1505:3008)' u_sinusoid(1507:3010)' u_sinusoid(1506:3009)' u_sinusoid(1505:3008)']; 
target_testing = y_sinusoid(1507:3010)';
